    ...
    for (const Y of V)
      if (Y.type === "childList")
        for (const ce of Y.addedNodes)
          ce.tagName === "LINK" && ce.rel === "modulepreload" && ze(ce);
...
function Tf() {
  ...
  (W.prototype.isReactComponent = {}),
    (W.prototype.setState = function (c, h) {
  ...
  function Qe(c, h, O) {
    var D,
      ...
      Q = null;
    if (h != null)
      for (D in (h.ref !== void 0 && (Q = h.ref),
      h.key !== void 0 && (F = "" + h.key),
      h))
        be.call(h, D) && !Le.hasOwnProperty(D) && (j[D] = h[D]);
    ...
    if (c && c.defaultProps)
      for (D in ((B = c.defaultProps), B)) j[D] === void 0 && (j[D] = B[D]);
    return {
      $$typeof: R,
      type: c,
      key: F,
  ...
  function en(c, h, O, D, j) {
    var F = typeof c;
    (F === "undefined" || F === "boolean") && (c = null);
    var Q = !1;
    if (c === null) Q = !0;
    else
      switch (F) {
    ...
    if (Q)
      return (
        ...
        ge(j)
          ? ((O = ""),
            c != null && (O = c.replace(cn, "$&/") + "/"),
            en(j, h, O, "", function (Ue) {
              return Ue;
            }))
          : j != null &&
            (gn(j) &&
    ...
    if (((Q = 0), (D = D === "" ? "." : D + ":"), ge(c)))
      ...
      for (c = q.call(c), B = 0; !(F = c.next()).done; )
        (F = F.value), (q = D + Fe(F, B++)), (Q += en(F, h, O, q, j));
    else if (F === "object")
      throw (
        ((h = String(c)),
        Error(
  ...
  return (
    ...
    (M.cloneElement = function (c, h, O) {
      ...
      if (h != null) {
        if (
          (h.ref !== void 0 && ((F = h.ref), (Q = Ce.current)),
        ...
        for (q in h)
          be.call(h, q) &&
            !Le.hasOwnProperty(q) &&
            (D[q] = h[q] === void 0 && B !== void 0 ? B[q] : h[q]);
      }
      ...
      return { $$typeof: R, type: c.type, key: j, ref: F, props: D, _owner: Q };
    }),
            ...
            e: for (var c = 0, h = S.length, O = h >>> 1; c < O; ) {
              ...
              if (0 > V(j, _))
                F < h && 0 > V(Q, j)
                  ? ((S[c] = Q), (S[F] = _), (c = F))
                  : ((S[c] = j), (S[D] = _), (c = D));
              else if (F < h && 0 > V(Q, _)) (S[c] = Q), (S[F] = _), (c = F);
              else break e;
            }
          }
          return L;
            ...
            return (
              ...
              _ > c
                ? ((S.sortIndex = _),
                  ...
                  m($) === null &&
                    S === m(_e) &&
                    (J ? (yn(Qe), (Qe = -1)) : (J = !0), re(ge, _ - c)))
                : ((S.sortIndex = h), A($, S), We || $e || ((We = !0), Te(be))),
              S
            );
          }),
...
var za;
function Df() {
  return za || ((za = 1), (No.exports = Mf())), No.exports;
}
/**
 * @license React
...
` + l[o].replace(" at new ", " at ");
  ...
  function Ho() {
    if (st) {
      var e = st,
        n = at;
      if (((at = st = null), Ao(e), n)) for (e = 0; e < n.length; e++) Ao(n[e]);
    }
  }
  function $o(e, n) {
    return e(n);
  ...
  var Zo = A.unstable_scheduleCallback,
  ...
  function Wt(e) {
    ...
    for (; 0 < Rn.length && ((t = Rn[0]), t.blockedOn === null); )
      ii(t), t.blockedOn === null && Rn.shift();
  }
  ...
  function Xl(e, n, t, r) {
    if (Tr) {
      var l = Gl(e, n, t, r);
      if (l === null) du(e, n, r, Rr, t), oi(e, r);
      else if (qa(l, e, n, t, r)) r.stopPropagation();
      else if ((oi(e, r), n & 4 && -1 < Ja.indexOf(e))) {
        for (; l !== null; ) {
          var u = tr(l);
          if (
            (u !== null && ti(u),
  ...
  function Nc(e, n) {
    switch (e) {
      ...
      case "textInput":
        return (e = n.data), e === hi && yi ? null : e;
      default:
        return null;
    }
  }
  function Pc(e, n) {
    if (dt)
      return e === "compositionend" || (!tu && gi(e, n))
        ? ((e = ci()), (Or = Zl = On = null), (dt = !1), e)
        : null;
    switch (e) {
      case "paste":
        return null;
  ...
  function Ci() {
    Xt && (Xt.detachEvent("onpropertychange", xi), (Gt = Xt = null));
  }
  function xi(e) {
    if (e.propertyName === "value" && jr(Gt)) {
      var n = [];
      ki(n, Gt, e, Fl(e)), Qo(Lc, n);
    }
  }
  function Rc(e, n, t) {
    e === "focusin"
      ? (Ci(), (Xt = n), (Gt = t), Xt.attachEvent("onpropertychange", xi))
      : e === "focusout" && Ci();
  }
  function Oc(e) {
  ...
  function Ur(e) {
    ...
    var n = mt[e],
      t;
    for (t in n) if (n.hasOwnProperty(t) && t in Ri) return (su[e] = n[t]);
    return e;
  }
  ...
  Mn(Oi, "onAnimationEnd"),
    Mn(Mi, "onAnimationIteration"),
    Mn(Di, "onAnimationStart"),
    Mn("dblclick", "onDoubleClick"),
    Mn("focusin", "onFocus"),
    Mn("focusout", "onBlur"),
    Mn(Ii, "onTransitionEnd"),
    ...
    Qo(function () {
      ...
      e: {
        ...
        if (v !== void 0) {
          ...
          for (var a = p, d; a !== null; ) {
            ...
            if (
              (d.tag === 5 &&
                ...
                ((d = w),
                f !== null &&
                  ((w = It(a, f)), w != null && x.push(er(a, w, d)))),
              oe)
            )
              break;
            a = a.return;
          ...
          0 < x.length &&
            ((v = new k(v, C, null, t, y)), g.push({ event: v, listeners: x }));
        }
      }
      if (!(n & 7)) {
        e: {
          ...
          if (
            ...
            if (
              ...
              (oe = k == null ? v : yt(k)),
              (d = C == null ? v : yt(C)),
              (v = new x(w, a + "leave", k, t, y)),
              (v.target = oe),
              (v.relatedTarget = d),
              (w = null),
              Gn(y) === p &&
                ((x = new x(f, a + "enter", C, t, y)),
                (x.target = d),
                (x.relatedTarget = oe),
                (w = x)),
              (oe = w),
        ...
        T &&
          (vi &&
            ...
            (dt || T !== "onCompositionStart"
              ? T === "onCompositionEnd" && dt && (z = ci())
              : ((On = y),
                (Zl = "value" in On ? On.value : On.textContent),
                (dt = !0))),
          (P = Ar(p, T)),
          0 < P.length &&
            ((T = new pi(T, e, null, t, y)),
            g.push({ event: T, listeners: P }),
            z ? (T.data = z) : ((z = wi(t)), z !== null && (T.data = z)))),
          (z = xc ? Nc(e, t) : Pc(e, t)) &&
            ((p = Ar(p, "onBeforeInput")),
            0 < p.length &&
              ((y = new pi("onBeforeInput", "beforeinput", null, t, y)),
...
`
  ...
  function Fn() {
    if (!Su && Sn !== null) {
      ...
      try {
        ...
        throw (Sn !== null && (Sn = Sn.slice(e + 1)), Zo(Hl, Fn), l);
      } finally {
        (H = n), (Su = !1);
      }
    }
  ...
  function Gr(e) {
    ...
    if (
      ...
      for (; n; ) Zi(e, n), (n = Dn(n.nextSibling));
    }
    if ((qi(e), e.tag === 13)) {
  ...
  function ns(e) {
    ...
    function v(f, a, d, w) {
      ...
      if (typeof d == "object" && d !== null) {
        ...
        if (Ot(d) || L(d)) return N !== null ? null : y(f, a, d, w, null);
        Zr(f, d);
      }
      return null;
    }
    function k(f, a, d, w, N) {
      ...
      if (typeof w == "object" && w !== null) {
        ...
        if (Ot(w) || L(w)) return (f = f.get(d) || null), y(a, f, w, N, null);
        Zr(a, w);
      }
      return null;
    }
    function C(f, a, d, w) {
      for (
        ...
        e && z && U.alternate === null && n(f, z),
          (a = u(U, a, T)),
          P === null ? (N = U) : (P.sibling = U),
          (P = U),
          (z = me);
      }
      if (T === d.length) return t(f, z), b && qn(f, T), N;
      if (z === null) {
        for (; T < d.length; T++)
          (z = g(f, d[T], w)),
            z !== null &&
    ...
    function x(f, a, d, w) {
      ...
      if (U.done) return t(f, z), b && qn(f, T), N;
      if (z === null) {
      ...
      return (typeof d == "string" && d !== "") || typeof d == "number"
        ? ((d = "" + d),
          a !== null && a.tag === 6
            ...
            : (t(f, a), (a = yo(d, f.mode, w)), (a.return = f), (f = a)),
          o(f))
        : t(f, a);
    }
    return oe;
  ...
  function Ou(e, n) {
    switch ((K(or, n), K(ur, e), K(mn, lr), (e = n.nodeType), e)) {
      case 9:
      case 11:
  ...
  function Uu(e, n, t, r, l, u) {
    if (
      ...
      (n.updateQueue = null),
      (n.lanes = 0),
      (tl.current = e === null || e.memoizedState === null ? ef : nf),
      (e = t(r, l)),
      ir)
    ) {
      u = 0;
  ...
  function as(e, n) {
    ...
    if (
      ...
      if (
        ((t.flags |= 2048),
        cr(9, fs.bind(null, t, r, l, n), void 0, null),
        pe === null)
      )
        throw Error(m(349));
      nt & 30 || cs(t, n, l);
  ...
  function Cs(e, n, t) {
    return nt & 21
      ? (tn(t, n) ||
          ((t = ei()), (te.lanes |= t), (tt |= t), (e.baseState = !0)),
        n)
    ...
    ef = {
      ...
      useReducer: function (e, n, t) {
        ...
        return (
          ...
          (r.queue = e),
          (e = e.dispatch = qc.bind(null, te, e)),
          [r.memoizedState, e]
        );
      },
      useRef: function (e) {
      ...
      useSyncExternalStore: function (e, n, t) {
        ...
        return (
          ...
          (r.flags |= 2048),
          cr(9, fs.bind(null, r, u, t, n), void 0, null),
          t
        );
      },
      useId: function () {
...
` +
  ...
  function Gu(e, n, t, r, l, u) {
    Bs(e, n);
    var o = (n.flags & 128) !== 0;
    if (!r && !o) return l && Yi(n, t, !1), xn(e, n, u);
    ...
    return (
      (n.flags |= 1),
      e !== null && o
        ? ((n.child = _t(n, e.child, null, u)), (n.child = _t(n, null, i, u)))
        : xe(e, n, i, u),
  ...
  function uf(e, n, t, r, l, u, o) {
    if (t)
      return n.flags & 256
        ? ((n.flags &= -257), (r = Ku(Error(m(422)))), sl(e, n, o, r))
        : n.memoizedState !== null
    ...
    if (l.data === "$!") {
      ...
      return (
        (r = i), (u = Error(m(419))), (r = Ku(u, r, void 0)), sl(e, n, o, r)
      );
    }
    if (((i = (o & e.childLanes) !== 0), Me || i)) {
      ...
      return vo(), (r = Ku(Error(m(421)))), sl(e, n, o, r);
    }
    return l.data === "$?"
      ? ((n.flags |= 128),
        (n.child = e.child),
    ...
    switch ((Eu(n), n.tag)) {
          ...
          (e === null || e.child === null) &&
            (Gr(n)
              ...
              : e === null ||
                ...
                ((n.flags |= 1024), rn !== null && (fo(rn), (rn = null)))),
          eo(e, n),
          ke(n),
          null
        );
      ...
      case 6:
        if (e && n.stateNode != null) Zs(e, n, e.memoizedProps, r);
          ...
          if (((t = et(or.current)), et(mn.current), Gr(n))) {
            if (
              ((r = n.stateNode),
              (t = n.memoizedProps),
              (r[pn] = n),
          ...
          if (b && Be !== null && n.mode & 1 && !(n.flags & 128))
            ...
            if (e === null) {
              ...
              Et(),
                ...
                (n.flags |= 4);
            ke(n), (u = !1);
          } else rn !== null && (fo(rn), (rn = null)), (u = !0);
        ...
        return n.flags & 128
          ...
          : ((r = r !== null),
            r !== (e !== null && e.memoizedState !== null) &&
              ...
              ((n.child.flags |= 8192),
              n.mode & 1 &&
                (e === null || ne.current & 1 ? ae === 0 && (ae = 3) : vo())),
  ...
  function dr(e, n, t) {
    ...
    if (((r = r !== null ? r.lastEffect : null), r !== null)) {
      ...
      do {
        if ((l.tag & e) === e) {
          var u = l.destroy;
          (l.destroy = void 0), u !== void 0 && no(n, t, u);
        }
        l = l.next;
      } while (l !== r);
    }
          ...
          e: for (; i !== null; ) {
            switch (i.tag) {
              case 5:
                ...
                break e;
              case 3:
                (ve = i.stateNode.containerInfo), (un = !0);
                break e;
              case 4:
                (ve = i.stateNode.containerInfo), (un = !0);
                break e;
      ...
      case 5:
        ...
        if (r & 4 && ((l = e.stateNode), l != null)) {
          ...
          if (((e.updateQueue = null), s !== null))
            try {
              i === "input" && u.type === "radio" && u.name != null && Ro(l, u),
                Il(i, o);
              var p = Il(i, u);
  ...
  function $n(e) {
    return e.mode & 1
      ? I & 2 && he !== 0
        ...
        ? (gl === 0 && (gl = ei()), gl)
        : ((e = H),
          e !== 0 || ((e = window.event), (e = e === void 0 ? 16 : ai(e.type))),
          e)
      : 1;
  }
  function sn(e, n, t, r) {
    if (50 < vr) throw ((vr = 0), (ao = null), Error(m(185)));
    Vt(e, t, r),
      (!(I & 2) || e !== pe) &&
        (e === pe && (!(I & 2) && (pl |= t), ae === 4 && Wn(e, he)),
        Ie(e, r),
  ...
  function sa(e, n) {
    ...
    if (r & 30 || r & e.expiredLanes || n) n = wl(e, r);
      ...
      I |= 2;
      var u = fa();
      (pe !== e || he !== n) && ((Nn = null), (Tt = ue() + 500), lt(e, n));
      do
        try {
          hf();
          break;
      ...
      Pu(),
        (dl.current = u),
        (I = l),
        ie !== null ? (n = 0) : ((pe = null), (he = 0), (n = ae));
    }
    if (n !== 0) {
      if (
        (n === 2 && ((l = $l(e)), l !== 0 && ((r = l), (n = co(e, l)))),
        n === 1)
      )
      ...
      if (n === 6) Wn(e, r);
        ...
        switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
          ...
          case 3:
            if (
              (Wn(e, r),
              (r & 130023424) === r && ((n = io + 500 - ue()), 10 < n))
            ) {
              if (Pr(e, 0) !== 0) break;
              ...
              e.timeoutHandle = hu(ut.bind(null, e, De, Nn), n);
              break;
            }
            ut(e, De, Nn);
            break;
          case 4:
            ...
            if (
              ...
              e.timeoutHandle = hu(ut.bind(null, e, De, Nn), r);
              break;
            }
            ut(e, De, Nn);
            break;
  ...
  function lt(e, n) {
    ...
    if ((t !== -1 && ((e.timeoutHandle = -1), $c(t)), ie !== null))
  ...
  function vo() {
    (ae === 0 || ae === 3 || ae === 2) && (ae = 4),
      pe === null || (!(tt & 268435455) && !(pl & 268435455)) || Wn(pe, he);
  }
  function wl(e, n) {
    var t = I;
    I |= 2;
    var r = fa();
    (pe !== e || he !== n) && ((Nn = null), lt(e, n));
    do
      try {
        vf();
        break;
    ...
    while (!0);
    if ((Pu(), (I = t), (dl.current = r), ie !== null)) throw Error(m(261));
  ...
  function ut(e, n, t) {
    var r = H,
      l = Ze.transition;
    try {
      (Ze.transition = null), (H = 1), yf(e, n, t, r);
    } finally {
      (Ze.transition = l), (H = r);
    }
    return null;
  ...
  function gf(e, n, t) {
    ...
    r !== null && r.delete(n),
      ...
      pe === e &&
        (he & t) === t &&
        (ae === 4 || (ae === 3 && (he & 130023424) === he && 500 > ue() - io)
          ? lt(e, 0)
          : (oo |= t)),
      Ie(e, n);
  }
  ...
  ha = function (e, n, t) {
    ...
    else (Me = !1), b && n.flags & 1048576 && Gi(n, Xr, n.index);
  ...
  function ga(e) {
    ...
    if (e.tag === 1) {
      var t = e.type;
      if (Oe(t)) return Ki(e, t, n);
    }
    return n;
  }
  function wa(e, n, t, r, l, u, o, i, s) {
    return (
      (e = wo(t, r, !0, e, l, u, o, i, s)),
      (e.context = ga(null)),
      (t = e.current),
      (r = Ne()),
      (l = $n(t)),
  ...
  (ti = function (e) {
    ...
    ($o = po),
    (Wo = rt);
  var Pf = { usingClientEntryPoint: !1, Events: [tr, yt, $r, Bo, Ho, po] },
    hr = {
  ...
  return (
    ...
    (je.hydrateRoot = function (e, n, t) {
      ...
      if (
        ...
        (n = wa(n, null, e, 1, t ?? null, l, !1, u, o)),
        (e[wn] = n.current),
        bt(e),
        r)
      )
...
function jf() {
  ...
  return R(), (xo.exports = If()), xo.exports;
}
var Ra;
function Ff() {
  if (Ra) return zl;
...
var Uf = Ff();
const Vf = "/assets/react-CHdo91hT.svg",
  Af = "/vite.svg";
function Bf() {
...
Uf.createRoot(document.getElementById("root")).render(
  Pe.jsx(Oa.StrictMode, { children: Pe.jsx(Bf, {}) })
);
